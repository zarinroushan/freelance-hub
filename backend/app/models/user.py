...
class User(Base):
    ...
    gigs_posted = relationship("Gig", back_populates="client", foreign_keys="Gig.client_id")
    ...
    saved_gigs = relationship("SavedGig", back_populates="user", cascade="all, delete-orphan")
