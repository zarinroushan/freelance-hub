...
from app.routers import users, gig, application, contracts, messages, reviews
...
app.include_router(gig.router, prefix="/api/gigs", tags=["Gigs"])
...
@app.get("/")
def root():
    return {"message": "Welcome to UniGigs API", "version": "1.0.0"}
